...
public class Application {
    ...
    // ODO Task 4: modify this method so that it takes in a getTopGradeUseCase
    ...
    private static JPanel createManageTeamCard(JFrame jFrame, LeaveTeamUseCase leaveTeamUseCase,
        ...
        // ODO Task 4: Add another button for "Get Top Grade" (check the getAverageButton for example)
        ...
        // ODO Task 4: Add action listener for getTopGrade button, follow example of getAverageButton
